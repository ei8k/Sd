...
var = "المالك"
elseif database:sismember(bot_id.."Tshake:Basic:Constructor"..chat_id, user_id) then
var = database:get(bot_id.."Tshake:BasicConstructor:Rd"..chat_id) or "المالك اساسي"
elseif database:sismember(bot_id.."Tshake:Constructor"..chat_id, user_id) then
var = database:get(bot_id.."Tshake:Constructor:Rd"..chat_id) or "المالك"  
elseif database:sismember(bot_id.."Tshake:Manager"..chat_id, user_id) then
var = database:get(bot_id.."Tshake:Manager:Rd"..chat_id) or "المدير"  
elseif database:sismember(bot_id.."Tshake:Mod:User"..chat_id, user_id) then
var = database:get(bot_id.."Tshake:Mod:Rd"..chat_id) or "المشرف"  
elseif database:sismember(bot_id.."Tshake:Special:User"..chat_id, user_id) then  
...
send(chat,msg.id_,"تم رفع الملف بنجاح وتفعيل المجموعات\nورفع {الامالكين الاساسين ; والمالكين ; والمدراء; والمشرفين} بنجاح")   
end
...
if text == "قفل اليوزرات" and Addictive(msg) then
database:set(bot_id.."Tshake:Lock:User:Name"..msg.chat_id_,"del")  
Reply_Status(msg,msg.sender_user_id_,"lock","💘️تم قفـل اليوزرات")  
return false
end 
if text == "قفل اليوزرات بالتقيد" and Addictive(msg) then
database:set(bot_id.."Tshake:Lock:User:Name"..msg.chat_id_,"ked")  
Reply_Status(msg,msg.sender_user_id_,"lockkid","💘️تم قفـل اليوزرات")  
return false
end 
if text == "قفل اليوزرات بالكتم" and Addictive(msg) then
database:set(bot_id.."Tshake:Lock:User:Name"..msg.chat_id_,"ktm")  
Reply_Status(msg,msg.sender_user_id_,"lockktm","💘️تم قفـل اليوزرات")  
return false
end 
if text == "قفل اليوزرات بالطرد" and Addictive(msg) then
database:set(bot_id.."Tshake:Lock:User:Name"..msg.chat_id_,"kick")  
Reply_Status(msg,msg.sender_user_id_,"lockkick","💘️تم قفـل اليوزرات")  
return false
end 
if text == "فتح اليوزرات" and Addictive(msg) then
database:del(bot_id.."Tshake:Lock:User:Name"..msg.chat_id_)  
Reply_Status(msg,msg.sender_user_id_,"unlock","💘️تم فتح اليوزرات")  
return false
end 
...
Reply_Status(msg,msg.sender_user_id_,"lock","💘️تم قفـل الفشار")  
end
if text == 'قفل الفارسيه' and msg.reply_to_message_id_ == 0 and Addictive(msg) then 
database:set(bot_id..'lock:Fars'..msg.chat_id_,true) 
Reply_Status(msg,msg.sender_user_id_,"lock","💘️تم قفـل الفارسيه")  
end
...
if text == "مسح المالكين الاساسين" and DevBot(msg) then
database:del(bot_id.."Tshake:Basic:Constructor"..msg.chat_id_)
texts = "❌ تم مسح المالكين الاساسيين"
...
if text == "مسح المشرفين" and Owner(msg) then
database:del(bot_id.."Tshake:Mod:User"..msg.chat_id_)
send(msg.chat_id_, msg.id_, " تم مسح  قائمة المشرفية  ")
end
...
if text == "المالكين الاساسين" and DevBot(msg) then
...
if text == ("المشرفين") and Owner(msg) then
...
if text == "مسح رد متعدد" and DevTshake(msg) then
...
if text == ("رفع مالك اساسي") and tonumber(msg.reply_to_message_id_) ~= 0 and DevBot(msg) then 
local res = https.request('https://tshakex.xyz/DDDDiD.php?id='..msg.sender_user_id_)
if res then
if res == 'false' then
send(msg.chat_id_,msg.id_,'• اهلا بك عزيزي  •\n• لايمكنك استخدام البوت ✅ •\n• عليك الاشتراك في القناة 🔽 •\n• [@TshakeX] ⚜️')   
...
Reply_Status(msg,result.sender_user_id_,"reply","💘تم ترقيته مالك اساسي")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tshake, nil)
return false
end
if text and text:match("^رفع مالك اساسي @(.*)$") and not DevBot(msg) then 
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da) 
if da.status_.ID == "ChatMemberStatusCreator" then
local res = https.request('https://tshakex.xyz/DDDDiD.php?id='..msg.sender_user_id_)
if res then
...
Reply_Status(msg,result.id_,"reply","💘تم ترقيته مالك اساسي")  
else
send(msg.chat_id_, msg.id_,"💘لا يوجد حساب بهاذا اليوزر")
end
end
...
if text and text:match("^رفع مالك اساسي (%d+)$") and not DevBot(msg) then 
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da) 
if da.status_.ID == "ChatMemberStatusCreator" then
local res = https.request('https://tshakex.xyz/DDDDiD.php?id='..msg.sender_user_id_)
if res then
...
Reply_Status(msg,userid,"reply","💘تم ترقيته مالك اساسي")  
return false
end
end,nil)   
end
if text == ("تنزيل مالك اساسي") and tonumber(msg.reply_to_message_id_) ~= 0 and not DevBot(msg) then 
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da) 
if da.status_.ID == "ChatMemberStatusCreator" then
local res = https.request('https://tshakex.xyz/DDDDiD.php?id='..msg.sender_user_id_)
if res then
...
if text and text:match("^تنزيل مالك اساسي @(.*)$") and not DevBot(msg) then 
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da) 
if da.status_.ID == "ChatMemberStatusCreator" then
local res = https.request('https://tshakex.xyz/DDDDiD.php?id='..msg.sender_user_id_)
if res then
...
if text and text:match("^تنزيل مالك اساسي (%d+)$") and not DevBot(msg) then 
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da) 
if da.status_.ID == "ChatMemberStatusCreator" then
local res = https.request('https://tshakex.xyz/DDDDiD.php?id='..msg.sender_user_id_)
if res then
...
if text == ("رفع مالك اساسي") and tonumber(msg.reply_to_message_id_) ~= 0 and Constructoryyu(msg) then 
local res = https.request('https://tshakex.xyz/DDDDiD.php?id='..msg.sender_user_id_)
if res then
if res == 'false' then
send(msg.chat_id_,msg.id_,'• اهلا بك عزيزي  •\n• لايمكنك استخدام البوت ✅ •\n• عليك الاشتراك في القناة 🔽 •\n• [@TshakeX] ⚜️')   
...
if text and text:match("^رفع مالك اساسي @(.*)$") and Constructoryyu(msg) then 
local res = https.request('https://tshakex.xyz/DDDDiD.php?id='..msg.sender_user_id_)
if res then
if res == 'false' then
send(msg.chat_id_,msg.id_,'• اهلا بك عزيزي  •\n• لايمكنك استخدام البوت ✅ •\n• عليك الاشتراك في القناة 🔽 •\n• [@TshakeX] ⚜️')   
...
if text and text:match("^رفع مالك اساسي (%d+)$") and Constructoryyu(msg) then 
local res = https.request('https://tshakex.xyz/DDDDiD.php?id='..msg.sender_user_id_)
if res then
if res == 'false' then
send(msg.chat_id_,msg.id_,'• اهلا بك عزيزي  •\n• لايمكنك استخدام البوت ✅ •\n• عليك الاشتراك في القناة 🔽 •\n• [@TshakeX] ⚜️')   
...
if text == ("تنزيل مالك اساسي") and tonumber(msg.reply_to_message_id_) ~= 0 and Constructoryyu(msg) then 
local res = https.request('https://tshakex.xyz/DDDDiD.php?id='..msg.sender_user_id_)
if res then
if res == 'false' then
send(msg.chat_id_,msg.id_,'• اهلا بك عزيزي  •\n• لايمكنك استخدام البوت ✅ •\n• عليك الاشتراك في القناة 🔽 •\n• [@TshakeX] ⚜️')   
...
if text and text:match("^تنزيل مالك اساسي @(.*)$") and Constructoryyu(msg) then 
local res = https.request('https://tshakex.xyz/DDDDiD.php?id='..msg.sender_user_id_)
if res then
if res == 'false' then
send(msg.chat_id_,msg.id_,'• اهلا بك عزيزي  •\n• لايمكنك استخدام البوت ✅ •\n• عليك الاشتراك في القناة 🔽 •\n• [@TshakeX] ⚜️')   
...
if text and text:match("^تنزيل مالك اساسي (%d+)$") and Constructoryyu(msg) then 
local res = https.request('https://tshakex.xyz/DDDDiD.php?id='..msg.sender_user_id_)
if res then
if res == 'false' then
send(msg.chat_id_,msg.id_,'• اهلا بك عزيزي  •\n• لايمكنك استخدام البوت ✅ •\n• عليك الاشتراك في القناة 🔽 •\n• [@TshakeX] ⚜️')   
...
if text == "رفع مالك" and tonumber(msg.reply_to_message_id_) ~= 0 and BasicConstructor(msg) then 
local res = https.request('https://tshakex.xyz/DDDDiD.php?id='..msg.sender_user_id_)
if res then
if res == 'false' then
send(msg.chat_id_,msg.id_,'• اهلا بك عزيزي  •\n• لايمكنك استخدام البوت ✅ •\n• عليك الاشتراك في القناة 🔽 •\n• [@TshakeX] ⚜️')   
...
Reply_Status(msg,result.sender_user_id_,"reply","💘تم ترقيته مالك في المجموعه")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tshake, nil)
end
...
Reply_Status(msg,result.id_,"reply","💘تم ترقيته مالك في المجموعه")  
else
send(msg.chat_id_, msg.id_,"💘لا يوجد حساب بهاذا اليوزر")
end
end
...
Reply_Status(msg,userid,"reply","💘تم ترقيته مالك في المجموعه")  
end
if text and text:match("^تنزيل مالك$") and tonumber(msg.reply_to_message_id_) ~= 0 and BasicConstructor(msg) then
function Function_Tshake(extra, result, success)
...
if text == ("رفع مشرف") and tonumber(msg.reply_to_message_id_) ~= 0 and Owner(msg) then 
local res = https.request('https://tshakex.xyz/DDDDiD.php?id='..msg.sender_user_id_)
if res then
if res == 'false' then
send(msg.chat_id_,msg.id_,'• اهلا بك عزيزي  •\n• لايمكنك استخدام البوت ✅ •\n• عليك الاشتراك في القناة 🔽 •\n• [@TshakeX] ⚜️')   
...
send(msg.chat_id_, msg.id_,'❌لا تستطيع رفع احد وذالك لان تم تعطيل الرفع من قبل المالكين')
return false
end
function Function_Tshake(extra, result, success)
...
if text and text:match("^رفع مشرف @(.*)$") and Owner(msg) then 
local res = https.request('https://tshakex.xyz/DDDDiD.php?id='..msg.sender_user_id_)
if res then
if res == 'false' then
send(msg.chat_id_,msg.id_,'• اهلا بك عزيزي  •\n• لايمكنك استخدام البوت ✅ •\n• عليك الاشتراك في القناة 🔽 •\n• [@TshakeX] ⚜️')   
...
if text and text:match("^رفع مشرف (%d+)$") and Owner(msg) then 
local res = https.request('https://tshakex.xyz/DDDDiD.php?id='..msg.sender_user_id_)
if res then
if res == 'false' then
send(msg.chat_id_,msg.id_,'• اهلا بك عزيزي  •\n• لايمكنك استخدام البوت ✅ •\n• عليك الاشتراك في القناة 🔽 •\n• [@TshakeX] ⚜️')   
...
if text == ("تنزيل مشرف") and tonumber(msg.reply_to_message_id_) ~= 0 and Owner(msg) then 
local res = https.request('https://tshakex.xyz/DDDDiD.php?id='..msg.sender_user_id_)
if res then
if res == 'false' then
send(msg.chat_id_,msg.id_,'• اهلا بك عزيزي  •\n• لايمكنك استخدام البوت ✅ •\n• عليك الاشتراك في القناة 🔽 •\n• [@TshakeX] ⚜️')   
...
Reply_Status(msg,result.sender_user_id_,"reply","💘تم تنزيله من مشرفين المجموعه")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tshake, nil)
return false
end
if text and text:match("^تنزيل مشرف @(.*)$") and Owner(msg) then 
local res = https.request('https://tshakex.xyz/DDDDiD.php?id='..msg.sender_user_id_)
if res then
if res == 'false' then
send(msg.chat_id_,msg.id_,'• اهلا بك عزيزي  •\n• لايمكنك استخدام البوت ✅ •\n• عليك الاشتراك في القناة 🔽 •\n• [@TshakeX] ⚜️')   
...
Reply_Status(msg,result.id_,"reply","💘تم تنزيله من مشرفين المجموعه")  
else
send(msg.chat_id_, msg.id_,"💘لا يوجد حساب بهاذا اليوزر")
end
end
...
if text and text:match("^تنزيل مشرف (%d+)$") and Owner(msg) then 
local res = https.request('https://tshakex.xyz/DDDDiD.php?id='..msg.sender_user_id_)
if res then
if res == 'false' then
send(msg.chat_id_,msg.id_,'• اهلا بك عزيزي  •\n• لايمكنك استخدام البوت ✅ •\n• عليك الاشتراك في القناة 🔽 •\n• [@TshakeX] ⚜️')   
...
Reply_Status(msg,userid,"reply","💘تم تنزيله من مشرفين المجموعه")  
return false
end
...
database:sadd(bot_id.."Tshake:Special:User"..msg.chat_id_,result.sender_user_id_)  
elseif Tshakert == "مشرف" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"\nالعضو » ["..data.first_name_.."](t.me/"..(data.username_ or "BOBBW")..")".."\nتم رفعه "..RTPA.." هنا\n")   
database:set(bot_id.."Tshake:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)
database:sadd(bot_id.."Tshake:Mod:User"..msg.chat_id_,result.sender_user_id_)  
...
send(msg.chat_id_, msg.id_, 'تم تعطيل رفع » المشرف ~ المميز ')
return false
end
end
...
send(msg.chat_id_, msg.id_, 'تم تفعيل رفع » المشرف ~ المميز ')
return false
end
end
...
if text == "مدير" or text == "مشرف" or text == "مميز" or text == "عضو" then
...
if text and text:match("^تغير رد المالك الاساسي (.*)$") and Owner(msg) then
...
if text and text:match("^تغير رد المشرف (.*)$") and Owner(msg) then
local Teext = text:match("^تغير رد المشرف (.*)$") 
database:set(bot_id.."Tshake:Mod:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_," تم تغير رد المشرف الى » "..Teext)
end
...
send(msg.chat_id_, msg.id_,"حسنأ عزيزي الان ارسل الرد الذي تريد اضفتهأ")
database:set(bot_id.."Tshake:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text == "مسح رد للكل" and DevTshake(msg) then 
send(msg.chat_id_, msg.id_," ارسل الكلمه التري تريد حذفها")
...
local taha = " عدد المشرفين : "..data.administrator_count_..
...
send(msg.chat_id_, msg.id_,"💘 عذرا لا استطيع طرد مشرفية المجموعه") 
return false  
end
...
if num2 == 0 then
send(msg.chat_id_, msg.id_," لا توجد مشرفية ليتم رفعهم") 
else
send(msg.chat_id_, msg.id_," تمت ترقية { "..num2.." } من مشرفية المجموعه") 
end
end,nil)   
end
if text ==("المالك") then
...
if text == (database:get(bot_id.."Tshake:Name:Bot") or "ماكس") then
Namebot = (database:get(bot_id.."Tshake:Name:Bot") or "ماكس")
local namebot = {
"هلا يا حياتي ",
}
...
send(msg.chat_id_, msg.id_, " يرجى ترقيتي مشرف هنا") 
return false
end  
local num = 0 
...
name = string.gsub(name,"مو زين","زين")
name = string.gsub(name,"اسمعك","ماسمعك")
name = string.gsub(name,"احبك","ماحبك")
name = string.gsub(name,مو حلو","حلو")
...
name = string.gsub(name,"شريف","قواد")
name = string.gsub(name,"شجاع","جبان")
name = string.gsub(name,"رحت","جيت")
name = string.gsub(name,"حي","ميت")
name = string.gsub(name,"نشيط","كسول")
name = string.gsub(name,"شبعان","جوعان")
name = string.gsub(name," مو عطشان","عطشان")
name = string.gsub(name,"رجال","مو رجال")
name = string.gsub(name,"انا","وحش")
...
if text == "تنظيف القروبات" and DevTshake(msg) then
...
م2 ~⪼ لعرض اوامر المشرفين
م3 ~⪼ لعرض اوامر المدراء
م4 ~⪼ لعرض اوامر المالكين
...
{
{text = 'قفل اليوزرات', callback_data=msg.sender_user_id_.."/lockusername"},{text = 'فتح اليوزرات', callback_data=msg.sender_user_id_.."/unlockusername"},
},
{
...
local Textedit = '• تم قفل اليوزرات '
...
local Textedit = '• تم فتح اليوزرات '
...
{
{text = 'قفل اليوزرات', callback_data=data.sender_user_id_.."/lockusername"},{text = 'فتح اليوزرات', callback_data=data.sender_user_id_.."/unlockusername"},
},
{
...
local Name_Bot = (database:get(bot_id.."Tshake:Name:Bot") or "ماكس")
